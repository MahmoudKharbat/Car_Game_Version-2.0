...
public class ButtonsGameActivity extends AppCompatActivity {
    ...
    public void startButtonsGame(){ // Function that is responsible about moving the stone in the tracks
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(buttonsGame.getStone().getParent() == buttonsGame.getCar().getParent() && (stonePlace > carPlace-50 && stonePlace < carPlace+50)){ // If the stone touches the car then there is a crash
                            ...
                            buttonsGame.getStone().setY(stonePlace + 1); // Move the stone in the y axis
                            buttonsGame.getCoin().setY(coinPlace + 1); // Move the coin in the y axis
